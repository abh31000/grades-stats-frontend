...
export default function How():React.JSX.Element {
    ...
    return(
        <>
            <motion.div initial="initial" whileHover="animate" className="h-[30.27vh] select-none font-[Inter] text-[118px] font-light text-black cursor-pointer hover:bg-black hover:text-white transition duration-150">
                <motion.div className="flex">
                    <h1 className="mx-8 py-2">Comment</h1>
