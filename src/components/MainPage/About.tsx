...
export default function About():React.JSX.Element {
    ...
    return(
        <>
            <motion.div initial="initial" whileHover="animate" className="h-[30.1vh] select-none group font-[Inter] text-[118px] font-light text-black border-black border-b-[3px] cursor-pointer hover:bg-black hover:text-white transition duration-150">
                <motion.div  className="flex">
                    <h1 className="mx-8">Sur ce projet</h1>
