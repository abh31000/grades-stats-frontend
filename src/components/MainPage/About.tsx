...
export default function About():React.JSX.Element {
    ...
    return(
        <>
            <motion.div onClick={() => setPage(1)} initial="initial" whileHover="animate" className="h-[30.1vh] select-none group font-[Inter] text-[118px] font-light text-black border-black border-b-[3px] cursor-pointer hover:bg-black hover:text-white transition duration-150">
                <motion.div  className="flex">
                    <motion.h1 initial={{y:"-100vh"}} animate={{y:0}} transition={{duration:0.8, delay:0.05, ease:"easeInOut"}} className="mx-8">Sur ce projet</motion.h1>
